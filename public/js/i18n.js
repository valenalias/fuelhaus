...
const I18N = {
  es: {
    ...
    hero: {
      ...
      sub: 'Comida real, preparada con ingredientes de primera, lista para comer. En tu puerta cada domingo.',
      ...
      badge_big: 'Lista.',
      badge_sub: 'Fresca · Natural · Alta proteína',
    },
    ...
    process: {
      ...
      step1_title: 'Armás tu semana',
      step1_p: 'Elegís tu plan y armás tu semana con las comidas del menú disponible. Nos contás tus alergias si tenés.',
      step2_title: 'Cocinamos',
      step2_p: 'Ingredientes frescos y orgánicos, seleccionados con criterio. Nutrición calculada en cada plato. Nada improvisado.',
    ...
    plans: {
      ...
      note_html: 'Elegís tus comidas semana a semana y nos contás tus alergias. <a href="#contacto">Habla con nosotros →</a>',
    },
    ...
    food: {
      ...
      p1: 'Ingredientes de primera calidad, preparados esa misma semana. Sin conservantes, sin procesados. Alta proteína en cada porción.',
      p2: 'Proteína, carbohidratos y grasas balanceados en cada plato. No es comida genérica — es comida real.',
    ...
    home: {
      ...
      label_special_note: 'Nota especial',
      ...
      sub_status_active_no_date: 'Activa',
      ...
      welcome_sub_html: 'Estás a cuatro pasos de tener tu semana de comida resuelta.<br>Todo fresco, delicioso y listo para comer.',
      w_step1: 'Elegís tu plan',
      w_step2: 'Armás tu semana',
      w_step3: 'Completás tus datos de entrega',
      w_step4: 'Confirmás tu pedido',
      start_btn: 'Empezar',

      step1_of_4: 'Paso 1 de 4',
      ...
      step3_of_4: 'Paso 3 de 4',
      delivery_title_html: 'Ya casi <em>está</em>',
      delivery_sub: 'Solo necesitamos algunos datos para preparar y entregar tu pedido.',
      ...
      delivery_details_title: 'Datos de entrega',
      label_address: 'Dirección *',
      address_placeholder: '123 Main St',
      label_apartment: 'Depto / Unidad (opcional)',
      apartment_placeholder: 'Apt 4B',
      label_city: 'Ciudad *',
      city_placeholder: 'Miami',
      label_zip: 'Código postal *',
      zip_placeholder: '33101',
      label_delivery_instructions: 'Instrucciones de entrega (opcional)',
      delivery_instructions_placeholder: 'Ej: portón azul, dejar con el portero...',
      delivery_window_label: 'Entrega',
      delivery_window_sunday_morning: 'Domingo por la mañana',
      allergies_question: '¿Tenés alguna alergia o restricción alimentaria?',
      allergies_placeholder: 'Ej: lácteos, gluten, maní...',
      special_note_question: '¿Hay algo más que debamos saber?',
      special_note_placeholder: 'Dejanos cualquier indicación especial para tu pedido.',
      err_delivery_required: 'Completá dirección, ciudad y código postal',
      closing_line: 'Una decisión menos. Una semana mejor.',

      step4_of_4: 'Paso 4 de 4',
      ...
      payment_disclaimer: 'Al confirmar se cobra tu plan hoy mismo y activás el cobro automático semanal (las próximas renovaciones caen cada martes), con entrega dominical en Miami. Podés cancelar cuando quieras desde tu cuenta — si cancelás antes del lunes, no se te cobra ni se prepara nada la semana siguiente.',
  ...
  en: {
    ...
    hero: {
      ...
      title_line2: 'solved.',
      sub: 'Real food, made with premium ingredients, ready to eat. On your doorstep every Sunday.',
      ...
      badge_big: 'Ready.',
      badge_sub: 'Fresh · Natural · High protein',
    },
    ...
    process: {
      ...
      step1_title: 'You build your week',
      step1_p: 'Choose your plan and build your week from the available menu. Let us know about any allergies.',
      step2_title: 'We cook',
      step2_p: 'Fresh, organic ingredients, chosen with care. Nutrition calculated in every dish. Nothing improvised.',
    ...
    plans: {
      ...
      note_html: 'You choose your meals every week and let us know about allergies. <a href="#contacto">Talk to us →</a>',
    },
    ...
    food: {
      ...
      p1: 'Top-quality ingredients, prepared that same week. No preservatives, no processed food. High protein in every serving.',
      p2: 'Protein, carbs and fats balanced in every plate. Not generic food — it\'s real food.',
    ...
    home: {
      ...
      label_special_note: 'Special note',
      ...
      sub_status_active_no_date: 'Active',
      ...
      welcome_sub_html: 'You\'re four steps away from having your week of food solved.<br>All fresh, delicious and ready to eat.',
      w_step1: 'Choose your plan',
      w_step2: 'Build your week',
      w_step3: 'Fill in your delivery details',
      w_step4: 'Confirm your order',
      start_btn: 'Get started',

      step1_of_4: 'Step 1 of 4',
      ...
      step3_of_4: 'Step 3 of 4',
      delivery_title_html: 'Almost <em>there</em>',
      delivery_sub: 'Just a few details to prepare and deliver your order.',
      ...
      address_placeholder: '123 Main St',
      label_apartment: 'Apartment / Unit (optional)',
      apartment_placeholder: 'Apt 4B',
      label_city: 'City *',
      city_placeholder: 'Miami',
      label_zip: 'ZIP Code *',
      zip_placeholder: '33101',
      label_delivery_instructions: 'Delivery instructions (optional)',
      delivery_instructions_placeholder: 'E.g: blue gate, leave with the doorman...',
      delivery_window_label: 'Delivery',
      delivery_window_sunday_morning: 'Sunday morning',
      allergies_question: 'Do you have any food allergies or restrictions?',
      allergies_placeholder: 'E.g: dairy, gluten, peanuts...',
      special_note_question: 'Anything else we should know?',
      special_note_placeholder: 'Leave any special instructions for your order.',
      err_delivery_required: 'Please fill in address, city and ZIP code',
      closing_line: 'One less decision. One better week.',

      step4_of_4: 'Step 4 of 4',
      ...
      payment_disclaimer: 'By confirming your plan is charged today and automatic weekly billing kicks in (future renewals fall every Tuesday), with Sunday delivery in Miami. You can cancel anytime from your account — cancel before Monday and you won\'t be charged or prepped for the following week.',
