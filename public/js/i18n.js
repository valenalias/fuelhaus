...
const I18N = {
  es: {
    ...
    login: {
      ...
      forgot_sub: 'Ingresá tu email y te mandamos un link para elegir una nueva.',
      forgot_btn: 'Enviar link',
      forgot_btn_loading: 'Enviando…',
      forgot_success: 'Si ese email tiene una cuenta, te llegará un link para restablecer tu contraseña.',
      back_to_login: '← Volver a ingresar',
      reset_title: 'Elegí tu nueva contraseña',
      reset_sub: 'Mínimo 6 caracteres.',
      label_new_password: 'Nueva contraseña',
      label_confirm_password: 'Confirmar contraseña',
      reset_btn: 'Guardar contraseña',
      reset_btn_loading: 'Guardando…',
      reset_success: '¡Listo! Ya podés ingresar con tu nueva contraseña.',
    ...
    home: {
      ...
      w_step2: 'Completás tus datos',
      w_step3: 'Configurás tus preferencias',
      ...
      payment_disclaimer: 'Al confirmar aceptás recibir tu plan semanal con entrega dominical en Miami.',
  ...
  en: {
    ...
    login: {
      ...
      forgot_sub: "Enter your email and we'll send you a link to choose a new one.",
      forgot_btn: 'Send link',
      forgot_btn_loading: 'Sending…',
      forgot_success: "If that email has an account, you'll get a link to reset your password.",
      back_to_login: '← Back to log in',
      reset_title: 'Choose your new password',
      reset_sub: 'At least 6 characters.',
      label_new_password: 'New password',
      label_confirm_password: 'Confirm password',
      reset_btn: 'Save password',
      reset_btn_loading: 'Saving…',
      reset_success: "Done! You can now log in with your new password.",
      reset_error_mismatch: "Passwords don't match",
    },
    ...
    home: {
      ...
      w_step2: 'Fill in your info',
      w_step3: 'Set your preferences',
      ...
      payment_disclaimer: 'By confirming you agree to receive your weekly plan with Sunday delivery in Miami.',
    ...
    api_errors: {
      ...
      'Ese link ya no es válido o expiró': 'This link is no longer valid or has expired',
    },
  },
};
